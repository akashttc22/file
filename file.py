...
except:ugen = ['Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS; Nokia 7610;451) Opera 6.20'] #Akash
try:ugen2 = open('user2.txt','r').read().splitlines()
except:ugen2 = ['Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS; Nokia 7610;451) Opera 6.20'] #Akash
...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mAKASH
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801635795657
\x1b[93;1m status       \x1b[92;1m=>      \x1b[93;1mFREE🤩
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://chat.whatsapp.com/HocCBerkiPXJC121wId8we")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [AKASH] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [AKASH-CP] %s|%s        '%(b,idf,pw))
